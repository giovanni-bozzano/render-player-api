...
public final class PlayerModelBaseSorter
{
    ...
    public PlayerModelBaseSorter(List<String> list, Map<String, String[]> allBaseSuperiors, Map<String, String[]> allBaseInferiors, String methodName)
    {
        this.list = list;
            ...
            for (int i = 0; i < this.list.size() - 1; i++) {
                for (int n = i + 1; n < this.list.size(); n++) {
                    ...
                    if (leftWantsToBeInferiorToRight && rightWantsToBeInferiorToLeft) {
                        throw new UnsupportedOperationException("Can not sort PlayerModelBase classes for method '" + this.methodName + "'. '" + left + "' wants to be inferior to '" + right + "' and '" + right + "' wants to be inferior to '" + left + "'");
                    }
                    if (leftWantsToBeSuperiorToRight && rightWantsToBeSuperiorToLeft) {
                        throw new UnsupportedOperationException("Can not sort PlayerModelBase classes for method '" + this.methodName + "'. '" + left + "' wants to be superior to '" + right + "' and '" + right + "' wants to be superior to '" + left + "'");
                    }

                    if (leftWantsToBeInferiorToRight && leftWantsToBeSuperiorToRight) {
                        throw new UnsupportedOperationException("Can not sort PlayerModelBase classes for method '" + this.methodName + "'. '" + left + "' wants to be superior and inferior to '" + right + "'");
                    }
                    if (rightWantsToBeInferiorToLeft && rightWantsToBeSuperiorToLeft) {
                        throw new UnsupportedOperationException("Can not sort PlayerModelBase classes for method '" + this.methodName + "'. '" + right + "' wants to be superior and inferior to '" + left + "'");
                    }
                }
            }
    ...
    private Set<String> build(String type, Set<String> inferiors, String startType)
    {
        ...
        for (String inferiorType : directInferiors) {
            if (inferiorType.equals(startType)) {
                throw new UnsupportedOperationException("Can not sort PlayerModelBase classes for method '" + this.methodName + "'. Circular superiority found including '" + startType + "'");
            }
            ...
            try {
                ...
                throw new UnsupportedOperationException("Can not sort PlayerModelBase classes for method '" + this.methodName + "'. Circular superiority found including '" + inferiorType + "'", uoe);
            }
